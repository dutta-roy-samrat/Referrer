...
const AuthLayout = ({ children }: { children: ReactNode }) => {
  return (
    <div className="grid lg:grid-cols-2 h-full w-full bg:black lg:bg-transparent">
      <div className="flex justify-start lg:justify-center items-center flex-col gap-5 bg-white text-black pt-24 pb-14">
        <ReferrerLogo className="animate-fade-in" />
        <div className="animate-forward-slide text-lg tracking-widest text-center font-extralight">
