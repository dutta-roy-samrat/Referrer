...
const SetNewPasswordForm: FC<SetNewPasswordFormProps> = ({ id, token }) => {
    ...
    const onSubmit = async (data) => {
        ...
        const res = await axiosInstance.post(`/auth/password-reset-confirm/${id}/${token}/`, formData);
        return res;
    };
    return (
        <form
        ...
        >
            <div className={styles.fieldContainer}>
                ...
                <input
                    ...
                    className={`${styles.inputContainer} ${errors.new_password ? styles.errorInput : ""
                        }`}
            ...
            <div className={styles.fieldContainer}>
                ...
                <input
                    ...
                    className={`${styles.inputContainer} ${errors.confirm_password ? styles.errorInput : ""
                        }`}
